  ...
  <div class="kd-app-main">
    ...
    <div class="kd-box">
      ...
      <div class="kd-box-content">
        ...
        <!--模块开始  -->
        <div v-if="state==0">
          <videoLive :total="total" :videoList="videoList" :showDetail="showDetail" @resh='resh' :detail="detail" @searchList="searchList" @detailLive="detailLive" @curpagese="curpagese"></videoLive>
        </div>
        <div v-if="state==1">
