                ...
                <div class="content">
                    <div style="width: 100%;height: 100%;">
                        ...
                        <el-row>
                            ...
                            <el-col :span="20" style="line-height: 23px;"><span style="color:rgb(19, 206, 102);cursor: pointer" @click="openB(merDetail.name,merDetail.url,600,400)">点击预览</span></el-col>
                        </el-row>
                        <el-row>
