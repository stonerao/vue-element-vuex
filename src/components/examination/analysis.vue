    ...
    <div>
        <el-row :gutter="10" class="class-header">
            <el-col :span="14" class="class-titles">
                <el-button type="primary" size="mini" @click="fanhui">返回</el-button>
                <span>
                    <img src="../../assets/index/shuaxin.png" class="icon-img-xs" @click="ajax" />刷新-共{{t_data.length}}条记录
                </span>
            </el-col>
...
export default {
    ...
    methods: {
        ajax() {
            this.t_data = []
            store.testpaper_statice.call(this)
        },
        fanhui() {
            this.$emit("fanhui")
        }
