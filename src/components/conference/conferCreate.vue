<template>
    <div>
        ...
        <div class="l_create_wrap">
            ...
            <el-row>
                ...
                <el-col :span="21">
                    ...
                    {{view_datas.length>0?view_datas.join(","):'暂未选择人员'}}
                    <el-button @click="setGM" class="marginleft10">选择参会人员</el-button>
                </el-col>
        ...
        <div class="myDialog">
            ...
            <vview @view_over="is_view=false" v-if="is_view" @data="view_data"></vview>
        </div>
        <!-- 213 -->
    </div>
</template>
...
import vview from '@/components/conference/view.vue'
...
export default {
    ...
    components: {
        titleItem, titleActive, description, bottomItem, vview
    },
    methods: {
        ...
        view_data(data) {
            this.create.confPeople = []
            this.view_datas = []
            data.forEach((x) => {
                this.create.confPeople.push(x.number_id);
                this.view_datas.push(x.teacher_name)
            })
            // this.view_datas
        }
    },
